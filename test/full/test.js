...
describe("RSA", function () {
    ...
    it("Should correctly verify the JWT", async function () {
        ...
        fs.writeFileSync('./json/jwtBytes.json', JSON.stringify(jwtBytes, null, 2));
        ...
        fs.writeFileSync('./json/jwtHeader.json', JSON.stringify(jwtH, null, 2));
        ...
        fs.writeFileSync('./json/jwtPayload.json', JSON.stringify(jwtP, null, 2));
        ...
        fs.writeFileSync('./json/rawSignature.json', JSON.stringify(Array.from(rawSignature), null, 2));
        ...
        fs.writeFileSync('./json/signatureChunks.json', JSON.stringify(signatureChunks, null, 2));
